var oldHash = '';
var baseUrl_API = "http://localhost:8000/FinalProject"; // you need to fill this variable with your own api url
...
function home() {
    ...
    updateMain('Home', 'Welcome, share your thoughts!', _html);
}
